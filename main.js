//https://teachablemachine.withgoogle.com/models/JnCT7Ixfg/
...
classifier=ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/JnCT7Ixfg/model.json',modelLoaded);
...
function gotresult(error,result){
    ...
    if(error){
        ...
        if(result[0].label=="ready to box"){
            document.getElementById("update_emoji").innerHTML="&#9994";
